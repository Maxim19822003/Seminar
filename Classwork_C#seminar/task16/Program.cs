 ...
 * При выводе матрицы показывать каждую цифру разного цвета(цветов 
всего 16)
*/
...
// Метод для заполнения 2D массива вещественными (doubl) 
//числами
...
int n = ReadData("Number of rows of the matrix: ");
int m = ReadData("Number of columns of the matrix: ");
